...
public class copyDS extends HttpServlet {
	...
	private void process(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if(path.equals("/login.do")) {
			System.out.println("MODEL 2 로그인 처리");
			...
			System.out.println("MODEL 2 로그아웃 처리");
			...
			System.out.println("MODEL 2 글 등록 처리");
			...
			System.out.println("MODEL 2 글 수정 처리");
			...
			System.out.println("MODEL 2 글 삭제 처리");
			...
			System.out.println("MODEL 2 글 상세 조회 처리");
			...
			System.out.println("MODEL 2 글 목록 검색  처리");
